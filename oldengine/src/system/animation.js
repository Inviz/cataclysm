...
P.animate.onPropertyChange = function(context, property, value, old) {
  ...
  if (property === 'zoom' && context === camera) {
    P.Person.instances.changes      |= P.Person.instances.UPDATE_SCALE;
    P.Company.instances.changes      |= P.Person.instances.UPDATE_SCALE;
    P.Sprite.instances.changes      |= P.Person.instances.UPDATE_RESET;
    P.Label.instances.changes       |= P.Person.instances.UPDATE_SCALE;
    P.Label.instances.front.changes       |= P.Person.instances.UPDATE_SCALE;
    P.Panel.instances.changes       |= P.Person.instances.UPDATE_SCALE;
    P.Icon.instances.changes        |= P.Person.instances.UPDATE_SCALE;
    P.Icon.instances.front.changes        |= P.Person.instances.UPDATE_SCALE;
    P.Background.instances.changes  |= P.Person.instances.UPDATE_SCALE;
    P.Background.instances.front.changes  |= P.Person.instances.UPDATE_SCALE;
    P.Background.instances.changes  |= P.Person.instances.UPDATE_OFFSET;
    P.Background.instances.front.changes  |= P.Person.instances.UPDATE_OFFSET;
  }
  if (property == 'opacity') {
  ...
  if (context == P.Line.instances.position)
