P.instances = function() {
  ...
  P.Scene.add(P.Floor.prototype.instances      = P.Floor.instances      = P.Floor.instanced());
  ...
  P.Scene.add(P.Background.instances.front);
  P.Scene.add(P.Icon.instances.front);
  P.Scene.add(P.Label.instances.front);
  P.Scene.add(P.Sprite.instances.front);
  P.Scene.add(P.Panel.prototype.instances      = P.Panel.instances       = P.Panel.instanced());
  

  P.Floor.instances.numInstances = 1024;  
  P.Wall.instances.numInstances = 1024;   
  P.Line.instances.numInstances = 1024;   
  P.Overlay.instances.numInstances = 1024; 
  P.Underlay.instances.numInstances = 512; 
  P.Sprite.instances.numInstances = 1024; 
  P.Person.instances.numInstances = 512;  
  P.Label.instances.numInstances = 64;   
  P.Panel.instances.numInstances = 64;   
  P.Icon.instances.numInstances = 64;
  P.Background.instances.numInstances = 64; 
  P.Background.instances.front.numInstances = 16; 
  P.Furniture.instances.numInstances = 512; 
